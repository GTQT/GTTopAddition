package meowmel.gttopaddition.element;
...
import meowmel.gttopaddition.api.utils.FluidStackHelper;
import meowmel.gttopaddition.integration.GTTAIntegration;
...
public class FluidStackElement implements IElement {
    ...
    @Override
    public int getID() {
        return GTTAIntegration.FLUID_STACK_ELEMENT;
    }
